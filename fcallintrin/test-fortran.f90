...
subroutine test(nd, Ns, Nt)
  ...
  do i=1,100
    ...
    ! call h3ddirectcp_new_cpp(nd, zk, Xs, Vs, ns, Xt, nt, Vt, thresh)
    call h3ddirectcpnew(nd, zk, Xs, Vs, ns, Xt, nt, Vt, thresh)
    ! call helm3d_vec_d2(nd, zk, Xs, Vs, ns, Xt, nt, Vt, thresh)
  enddo
  tt = tt + omp_get_wtime()
  print*, "Vectorized : ", tt
